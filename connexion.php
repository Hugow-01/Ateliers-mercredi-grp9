...
<img src="images/dessin.jpg" alt="Enfants atelier" class="illustration-banner" onerror="this.style.height='80px'; this.style.background='#fdd835'">
    ...
    <div class="auth-box">
        ...
        <form method="POST" action="connexion.php">
            ...
            <div class="form-group">
                ...
                <input type="text" name="login" placeholder="ex: marie.alice@gmail.com"
