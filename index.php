 ...
 *
 * Affiche le hero, les trois piliers de présentation et
 * un bloc "à propos" avec la carte Google Maps en footer.
 * La nav change selon si l'utilisateur est connecté ou non.
 */

require_once 'php/index.php'; // Chargement de la session et des fonctions utilitaires

// Variables passées au header commun
$pageTitle  = 'Les Ateliers du Mercredi';
$activePage = 'accueil';
$extraCSS   = ['index.css'];
...
<div class="container">
    <div class="hero-bg">
        <div class="hero-content">
            ...
            <p style="font-size:1.2rem; margin-top:10px; opacity:0.9;">
                Des activités créatives et éducatives pour vos enfants
            </p>

            <!-- Boutons d'action adaptés au rôle (admin / parent / visiteur) -->
            <div class="hero-actions">
                <?php if (isLoggedIn()): ?>
                    <?php if (isAdmin()): ?>
                        <a href="admin-dashboard.php" class="btn"
                           style="background:#8c9eff;color:white;padding:13px 35px;font-size:1.1rem;border-radius:25px;">
                            Mon tableau de bord
                        </a>
                    <?php else: ?>
                        ...
                        <a href="activites.php" class="btn btn-primary"
                           style="padding:13px 35px;font-size:1.1rem;border-radius:25px;">
                            Voir les activités
                        </a>
                    <?php endif; ?>
                <?php else: ?>
    ...
    <!-- ══ Bloc "À propos" avec photo ══ -->
    <div style="display:flex;align-items:center;gap:40px;margin:60px 0;flex-wrap:wrap;">
        <div style="flex:1;min-width:280px;">
            <img src="images/acc.jpg" alt="Atelier"
                 style="width:100%;border-radius:20px;box-shadow:0 5px 15px rgba(0,0,0,0.1);"
        ...
        <div style="flex:1;min-width:280px;">
            ...
            <p style="line-height:1.8;color:#333;margin-bottom:15px;">
                Les Ateliers du Mercredi proposent aux enfants des activités variées, éducatives et ludiques,
                adaptées à leur âge, dans un cadre sécurisé et bienveillant.
            </p>
            <p style="line-height:1.8;color:#333;">
                Chaque mercredi, les enfants découvrent, apprennent et s'épanouissent tout en prenant plaisir à
                participer. Les parents disposent d'un espace dédié pour inscrire leurs enfants, choisir les
                ateliers et les créneaux disponibles en toute simplicité.
            </p>
        </div>
    </div>
</div>

<!-- ══ Footer avec carte Google Maps ══ -->
